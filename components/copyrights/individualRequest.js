...
<div className="px-[2rem] text-[#c0cecf] text-right  text-[1.7rem] sm:text-[1.7rem] -mb-[1.6rem] mt-[0.4rem] whitespace-nowrap overflow-hidden text-ellipsis">
<span className="text-[#f5f5f5] font-semibold text-[1.8rem] capitalize mr-[1.5rem]">{data?.status}</span>            {date.toLocaleString()}
          </div>
      ...
      <div className="flex items-center space-x-[3rem] sm:space-x-[1rem] w-[60%] mt-[0.8rem] sm:mt-0">
                                    ...
                                    <h3 className="whitespace-nowrap text-[#f5f5f5] font-semibold text-[1.7rem] sm:text-[1.9rem]  tracking-wider">
      ...
      <div  className={`flex  items-center space-x-[0.4rem] hover:text-[blue] py-[0.9rem] border-[#d4dee2] cursor-pointer`}>
                                        ...
                                        <div className="text-ellipsis overflow-x-hidden px-[0.5rem] sm:px-[1.4rem]">
                                            <h3 className="text-[#d7cdeb] whitespace-nowrap  text-[1.9rem] sm:text-[1.9rem]  font-medium">
                                    ...
                                    <h3 className="text-[#eee8e8] font-semibold text-[1.9rem] sm:text-[1.9rem]  tracking-wider">
                                        Offer:
                                    </h3>
                                    <h3 className="text-[#d7cdeb] whitespace-nowrap text-[1.9rem] sm:text-[1.9rem]  font-medium">
