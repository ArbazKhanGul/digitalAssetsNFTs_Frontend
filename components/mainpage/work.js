...
<div className="w-[100%] lg:w-[47%]"><h2 className="workhead  text-[2.3rem] sm:text-[3rem] xl:text-[3.5rem] font-bold  font-[Inter] text-center sm:text-start">How Golden Words Nfts Work:</h2>
