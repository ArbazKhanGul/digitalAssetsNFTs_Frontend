...
<div className="w-[100%] lg:w-[47%]"><h2 className="workhead  text-[2.7rem] sm:text-[3rem] xl:text-[3.5rem] font-bold  font-[Inter] leading-[3.5rem]">How Golden Words Nfts Work:</h2>
<p className="text-[#f5f1f1] text-[1.6rem] xl:text-[1.5rem] text-justify pt-[1.5rem]">
