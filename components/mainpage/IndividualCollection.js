...
const IndividualCollections=({num,collectionname,volume,price,image}) =>{
    ...
    return (<>
        <div className={"hidden sm:border-b-0 sm:flex border-[#b1b1b1]   justify-start space-y-[1rem] pl-[2.3rem] sm:pl-[0rem]  sm:pb-[0rem] sm:space-y-[0.5rem] sm:justify-around items-start sm:items-center  flex-col sm:flex-row "+(num!=9?"border-b-[1px] pb-[1rem]":"")}>
...
//   objectFit="cover"
  ...
  <div className="font-['Inter'] text-[2rem] sm:text-[2rem] md:text-[2.2rem] text-[#5F5454CF] ">{collectionname} </div>
    ...
    <div className={"flex sm:hidden sm:border-b-0 border-[#b1b1b1]   justify-start space-y-[1rem] pl-[2.3rem] sm:pl-[0rem]  sm:pb-[0rem] sm:space-y-[0.5rem] sm:justify-around items-start sm:items-center  flex-col sm:flex-row "+(num!=9?"border-b-[1px] pb-[1rem]":"")}>
    
    
    <div className="flex  gap-[1.5rem] items-center">
  <div className="text-[#0B0A0A8A] text-[2rem] sm:text-[2rem] md:text-[2.2rem] font-bold font-['Inter']" >{num}.
       </div>  
         <div className=" inline-block w-[5.5rem] h-[5.5rem] sm:w-[3.2rem] md:w-[3.5rem] sm:h-[3.2rem] md:h-[3.5rem] rounded-full relative">
  <Image 
  className="rounded-full"
  src={image}
  layout="fill"
 /></div>
  <div className="flex-1 font-['Inter'] text-[2rem] sm:text-[2rem] md:text-[2.2rem] text-[#5F5454CF] ">
    <div className="text-black font-semibold">{collectionname}</div>
    
    
    <div className="flex justify-between">
    <div className="text-[#5F5454CF] text-[1.8rem] sm:text-[1.8rem] md:text-[2rem] font-['Inter']"><span className="inline-block sm:hidden text-[1.8rem] colgrad">Floor Price : </span>${price}</div>
