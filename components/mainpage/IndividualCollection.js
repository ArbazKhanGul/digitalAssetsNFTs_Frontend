...
const IndividualCollections=({num,collectionname,volume,price,image}) =>{
    ...
    return (
        <div className="flex border-b-[1px] border-[#666b70]   justify-start space-y-[1rem] ml-[2rem] sm:space-y-[0.5rem] sm:justify-around items-start sm:items-center  flex-col sm:flex-row">
