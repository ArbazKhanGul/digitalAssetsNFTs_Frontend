...
function FeeUpdate({ creationFee, contentFee, values, userinfo, setLoader ,loader,hash}) {
                        ...
                        {loader == "confirm" ? <>
                            ...
                            <div className="flex px-[2rem] space-x-[1rem] mb-[1rem] mt-[0.5rem]">
                                <div className="pb-[1rem]">
                                    ...
                                    <button className="bg-[#1E40AF]  hover:bg-[#38398b]  text-white font-normal text-[1.7rem] sm:font-semibold py-[0.7rem] px-14 rounded-full font-['Inconsolata'] tracking-wider"
                                        ...
                                        onClick={async () => {
                                            ...
                                            await ipfsUpload(values, userinfo, setLoader, setPath,num1.add(num2),hash);
                                        }}
                                    >
                                        Confirm
                                    </button>
                                ...
                                <div className="pb-[1rem]">
                                    ...
                                    <button className="bg-[#1b31c4] hover:bg-[#182ba8]   text-white font-normal text-[1.7rem] sm:font-semibold py-[0.7rem] px-14 rounded-full font-['Inconsolata'] tracking-wider"
                                        type="submit"
                                        onClick={() => {
                                            setLoader(false);
                                        }}
