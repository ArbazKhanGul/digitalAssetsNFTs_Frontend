...
function Detail({setPlatfomrBnbIncrement}) {
  ...
  const {
    ...
    onSubmit: async (values, action) => {
      ...
      try {
        ...
        const response = await axios.post("/changebuyingoption", { platformBnbIncrement: values.amount });


        if (response?.data?.status == "success") {
          setPlatfomrBnbIncrement(values.amount)
