...
<meta property="twitter:type" content="website" />
        ...
        <meta property="twitter:site_name" content="Golden Words Nfts" />
        <meta
          ...
          <div className="w-[98.5%] sm:w-[100%] nft_bord row-start-3 max-h-[43rem] lg:max-h-[60rem]  row-end-4 lg:col-start-1 lg:col-end-2 lg:row-start-1 lg:row-end-3">
            <div className="w-[100%] h-[100%] lg:h-[47rem] flex justify-content items-center  overflow-y-auto relative p-[1.5rem] sm:p-[3rem] ">
              <h2 className="text-[2rem] sm:text-[2.5rem]  text-['#2d3436'] font-['Inconsolata'] font-normal text-justify  max-h-[100%]">
                ...
                voluptate repellendus beatae. Blanditiis facere velit aut
                commodi deserunt, ut dolore incidunt vel voluptates molestiae
                repudiandae, veniam, ipsam ipsa magni omnis? Consequatur
                excepturi consequuntur similique explicabo obcaecati, eveniet
                maxime incidunt ut, eius officiis rem! Numquam harum delectus
                nostrum ut ex adipisci aliquam quod, dicta nobis veritatis
                nulla? A, qui deleniti nam et perspiciatis voluptatibus vero
                dolorum cupiditate nulla enim earum? Consectetur, facere! Nobis
                pariatur recusandae quas enim quae aut a, aperiam cupiditate
                provident dolorem eius illo odit dignissimos animi, ipsa nihil
                harum obcaecati similique numquam maiores aspernatur? Eius,
                cumque atque?
              </h2>
            </div>
          </div>
                  ...
                  <div className="relative w-auto my-6 mx-auto max-w-3xl">
                    ...
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                      ...
                      <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                        <h3 className="text-3xl font-semibold">{clickCheck}</h3>
                        <button
                          ...
                          <div>
                              ...
                              <div className="flex  w-auto sm:w-[350px] flex-wrap  items-center justify-center">
                                <div className="flex justify-center flex-col items-center space-y-[0.4rem]  mr-[2rem] mt-[1rem]">
                                  ...
                                  >
                                    ...
                                    <p className="text-[#A1A1A1] text-[1.1rem]">
                                      Facebook
                                    </p>
                                  </FacebookShareButton>
                                </div>
                                ...
                                <div
                                  className="flex justify-center flex-col items-center space-y-[0.4rem] mr-[2rem] mt-[1rem]"
                                  onClick={() => setclickCheck("Embed Video")}
                                >
                            ...
                            {clickCheck == "Qr code" ? (
                              <div className="flex justify-center flex-col items-center">
                                ...
                                <a
                                  onClick={downloadQR}
                                  className="text-[1.6rem] text-blue-600 cursor-pointer"
                                >
                                  {" "}
                                  Download QR Code{" "}
                                </a>
