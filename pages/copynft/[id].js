        ...
        onSubmit: async (values, action) => {
            ...
            try {
                ...
                if (values.nftContentUse == "no") {
                    ...
                    else if(nftData.contentType=="image"){
                        hashCal = await generateFileHash(values.nftImage);
                      }

                }

                const response = await axios.post("/copyfee", { size, contentType: nftData.contentType,hash:hashCal});
                ...
                console.log("🚀 ~ file: [id].js:159 ~ onSubmit: ~ error:", error)
                setLoader(false)
            ...
            {!loading ? (
                ...
                <>
                    ...
                    <form onSubmit={handleSubmit} className='w-[100%] flex justify-center '>
                        ...
                        <div className="overflow-x-hidden w-11/12 sm:w-10/12 md:w-8/12 lg:w-[55%] flex my-[3.5rem] py-[1.4rem] lg:py-[2rem] rounded-3xl flex-col px-[2rem] lg:px-[2.5rem] bg-white  space-y-[1rem] mb-[2rem] shad">


                            <div className="text-[3rem]  flex  justify-center   font-semibold sm:text-[2.6rem] mb-[1rem] ">
                            ...
                            <div className=" mt-[2.5rem]">
                                <h2 className=" text-[#0D1344E5'] text-[2.2rem] sm:text-[2.4rem] font-semibold  tracking-wider">Original NFT Detail: </h2>

                            </div>

                            <div className="flex space-x-[9rem] items-center">
                                <h2 className=" text-[#0D1344E5] text-[1.8rem] font-medium sm:text-[1.85rem] tracking-wider">NFT Name: </h2>
                                <h3
                                    onClick={() => { router.push(`/individualnft/${nftData?.tokenURI}`) }}
                                    className="w-fit text-[#328699] cursor-pointer decoration-[#328699] decoration-1 underline underline-offset-1 text-[1.7rem] sm:text-[1.8rem]  font-medium">
                                    {nftData?.nftName}
                                </h3>
                            </div>
                            ...
                            <div className=" flex space-x-[5rem] items-center">
                                <div className="flex items-center space-x-[4rem]">
                                    <h2 className=" text-[#0D1344E5] font-medium text-[1.8rem] sm:text-[1.85rem] tracking-wider">NFT Creator: </h2>
                                    <div onClick={() => { router.push(`/profile/${nftData?.creator?._id}`) }} className={`flex  items-center space-x-[0.4rem] hover:text-[blue] py-[0.9rem] border-[#d4dee2] cursor-pointer`}>
                                        ...
                                        <div className="grow text-ellipsis overflow-x-hidden px-[0.4rem] sm:px-[1.4rem]">
                                            <h3 className="text-[#328699] cursor-pointer decoration-[#328699] decoration-1 underline underline-offset-1 text-[1.7rem] sm:text-[1.8rem]  font-medium">
                            ...
                            <div className="flex space-x-[4rem] items-center">
                                <div className="flex items-center space-x-[2rem]">
                                    <h2 className=" text-[#0D1344E5] font-medium text-[1.8rem] sm:text-[1.85rem] tracking-wider">Current Owner: </h2>
                            ...
                            <div className="mb-[0.4rem] flex space-x-[5rem] items-center">
                                <h2 className=" text-[#0D1344E5'] text-[1.8rem] sm:text-[1.85rem] tracking-wider">Content Type: </h2>
                                <h3
                                    // onClick={() => { router.push(`/individualnft/${data?.nftId}`) }}
                                    className="w-fit cursor-pointer text-[#545151]  text-[1.7rem] sm:text-[1.8rem]  font-medium">
                                    {nftData?.contentType}
                                </h3>
                            </div>
                            ...
                            <div className="mt-[0rem]">
                                <h2 className=" text-[#0D1344E5]  text-[2.2rem] sm:text-[2.5rem] font-[2.4rem] font-semibold  tracking-wider mt-[0.4rem]">NFT Creation Detail: </h2>

                            </div>

                            <div className="">
                                <h2 className=" text-[#0D1344E5] font-medium text-[1.8rem] sm:text-[1.85rem] tracking-wider">Use the same content of original nft: </h2>
    ...
    // onClick={() => { router.push(`/individualnft/${data?.nftId}`) }}
                 className="w-fit cursor-pointer text-[#545151]  text-[1.9rem] sm:text-[2.2rem]  font-medium">
                            ...
                            {nftData?.contentType == "image" && values.nftContentUse == "no" ?
                                <div className="">
                                    <div className="reginpfile w-[100%] mb-[1rem] ">
                                        <span className="text-start block w-[84%]  text-[#0D1344E5] font-medium text-[2rem] tracking-wider">
                            ...
                            {nftData?.contentType == "text" && values.nftContentUse == "no" ?
                                <>
                                    <div className="">
                                        <h2 className=" text-[#0D1344E5] font-medium text-[2rem] tracking-wider">Choose language for text of NFT:</h2>
                                        <div className="mt-[1rem] w-[100%] relative ">
                                            <div className="input_bord_grad  mb-[0.2rem] !w-[100%]">
                                    ...
                                    <div className="flex flex-col h-fit">
                                        <h2 className=" text-[#0D1344E5] font-medium text-[2rem] tracking-wider">Enter Text for NFT:</h2>
                                        <h2 className=" text-[red] text-[1.7rem] tracking-wider">Instructions:</h2>
                                        <h2 className=" text-[1.3rem]  text-[#0D1344E5'] flex mt-[0.3rem]">
                                            <span className="text-[1.3rem] font-bold text-black pr-[0.5rem]">1.</span>
                                        ...
                                        <h2 className=" text-[1.3rem]  text-[#0D1344E5'] flex mt-[0.3rem]">
                                            <span className="text-[1.3rem] font-bold text-black pr-[0.5rem]">2.</span>
                            ...
                            <div className="mb-[2rem]">
                                ...
                                <button className="bg-[#1b31c4] hover:bg-[#182ba8]  text-white font-normal text-[1.7rem] sm:font-semibold py-[0.7rem] px-12 mb-[1rem]   rounded-[1.5rem]  tracking-wider"
                                    type="submit"
                                // disabled={loader}
                                >
                ...
                duplicateNft ?
                  ...
                  (
                    ...
                    <div className="">   
                      <div className="flex ">
                        <h2 className=" font-['Inconsolata'] text-[2.2rem] text-[red]">Your Nft content match with below nft content:</h2>
                      </div>
                      <div className="mb-[2rem] w-[100vw] !mr-[50rem]">
